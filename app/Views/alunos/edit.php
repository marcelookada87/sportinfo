<div class="page-header">
    ...
    <a href="<?= BASE_URL ?>/alunos/<?= $aluno['id'] ?>" class="btn btn-secondary">Voltar</a>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>/alunos/<?= $aluno['id'] ?>" data-validate>
            <?php
            // Gera token CSRF
            ...
            <input type="hidden" name="_method" value="PUT">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control" 
                        required
                        value="<?= htmlspecialchars($aluno['nome'], ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control"
                        maxlength="14"
                        value="<?= !empty($aluno['cpf']) ? preg_replace('/(\d{3})(\d{3})(\d{3})(\d{2})/', '$1.$2.$3-$4', $aluno['cpf']) : '' ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control"
                        maxlength="20"
                        value="<?= htmlspecialchars($aluno['rg'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        required
                        max="<?= date('Y-m-d') ?>"
                        value="<?= htmlspecialchars($aluno['dt_nascimento'], ENT_QUOTES, 'UTF-8') ?>"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="contato" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['contato'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['contato_emergencia'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="(00) 00000-0000"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['nome_contato_emergencia'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="email" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['email'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="nome_pai" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['nome_pai'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="telefone_pai" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['telefone_pai'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="(00) 00000-0000"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="email_pai" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['email_pai'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="email@exemplo.com"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="telegram_pai" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['telegram_pai'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="nome_mae" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['nome_mae'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="telefone_mae" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['telefone_mae'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="(00) 00000-0000"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="email_mae" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['email_mae'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="email@exemplo.com"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="telegram_mae" 
                        class="form-control"
                        value="<?= htmlspecialchars($aluno['telegram_mae'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                        placeholder="@usuario_telegram"
                    >
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    ><?= htmlspecialchars($aluno['endereco'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    ><?= htmlspecialchars($aluno['alergias'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    ><?= htmlspecialchars($aluno['observacoes_medicas'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                </div>
                            ...
                            <?php foreach ($modalidades as $modalidade): ?>
                                <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; padding: 0.5rem; border: 1px solid var(--border-color); border-radius: var(--radius-md); transition: all 0.2s;">
                                    <input 
                                        ...
                                        <?= in_array($modalidade['id'], $modalidadesAluno ?? []) ? 'checked' : '' ?>
                                    >
            ...
            <div class="form-actions">
                ...
                <a href="<?= BASE_URL ?>/alunos/<?= $aluno['id'] ?>" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</div>
