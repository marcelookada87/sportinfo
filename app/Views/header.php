...
<head>
    ...
    <?php if (strpos($_SERVER['REQUEST_URI'] ?? '', '/alunos') !== false || strpos($_SERVER['REQUEST_URI'] ?? '', '/professores') !== false || strpos($_SERVER['REQUEST_URI'] ?? '', '/modalidades') !== false || strpos($_SERVER['REQUEST_URI'] ?? '', '/planos') !== false || strpos($_SERVER['REQUEST_URI'] ?? '', '/matriculas') !== false || strpos($_SERVER['REQUEST_URI'] ?? '', '/turmas') !== false): ?>
