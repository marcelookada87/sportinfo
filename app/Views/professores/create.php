<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-subtitle">Preencha os dados do professor</p>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>/professores" data-validate>
            <?php
            // Gera token CSRF
    ...
    <div class="card-body">
            <div class="form-group">
                ...
                <input 
                    ...
                    name="registro_cref" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['registro_cref'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group form-group-full">
                ...
                <textarea 
                    ...
                    class="form-control"
                    rows="4"
                    placeholder="Ex: Graduação em Educação Física - Universidade XYZ (2010-2014)&#10;Pós-graduação em Treinamento Esportivo - Universidade ABC (2015-2016)"
                ><?= htmlspecialchars($_POST['formacao_academica'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
            ...
            <div class="form-group form-group-full">
                ...
                <textarea 
                    ...
                    class="form-control"
                    rows="4"
                    placeholder="Ex: Certificação em Natação Infantil - Confederação Brasileira (2018)&#10;Curso de Primeiros Socorros - Cruz Vermelha (2019)"
                ><?= htmlspecialchars($_POST['certificacoes'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
            ...
            <div class="form-group form-group-full">
                ...
                <textarea 
                    ...
                    class="form-control"
                    rows="4"
                    placeholder="Ex: Professor de Natação - Academia XYZ (2015-2020)&#10;Treinador de Futebol - Clube ABC (2020-presente)"
                ><?= htmlspecialchars($_POST['experiencia_profissional'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="especialidade" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['especialidade'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    step="0.01"
                    min="0"
                    value="<?= htmlspecialchars($_POST['valor_hora'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    placeholder="0.00"
                >
            </div>
    ...
    <div class="card-body">
            <div class="form-group">
                ...
                <input 
                    ...
                    name="banco_nome" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['banco_nome'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="banco_agencia" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['banco_agencia'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    placeholder="0000"
                >
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="banco_conta" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['banco_conta'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    placeholder="00000-0"
                >
            </div>
            ...
            <div class="form-group">
                ...
                <select id="banco_tipo_conta" name="banco_tipo_conta" class="form-control">
                    <option value="">Selecione...</option>
                    <option value="Corrente" <?= ($_POST['banco_tipo_conta'] ?? '') === 'Corrente' ? 'selected' : '' ?>>Corrente</option>
                    <option value="Poupança" <?= ($_POST['banco_tipo_conta'] ?? '') === 'Poupança' ? 'selected' : '' ?>>Poupança</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="banco_pix" 
                    class="form-control"
                    value="<?= htmlspecialchars($_POST['banco_pix'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="form-actions">
                ...
                <a href="<?= BASE_URL ?>/professores" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</div>
