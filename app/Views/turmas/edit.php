<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-subtitle">Atualize os dados da turma</p>
    </div>
    <a href="<?= BASE_URL ?>/turmas/<?= $turma['id'] ?>" class="btn btn-secondary">Voltar</a>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>/turmas/<?= $turma['id'] ?>" data-validate>
            <?php
            // Gera token CSRF
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    class="form-control" 
                    required
                    value="<?= htmlspecialchars($turma['nome'], ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <select id="modalidade_id" name="modalidade_id" class="form-control" required>
                    ...
                    <?php foreach ($modalidades as $modalidade): ?>
                        <option value="<?= $modalidade['id'] ?>" <?= $turma['modalidade_id'] == $modalidade['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="nivel" 
                    class="form-control"
                    value="<?= htmlspecialchars($turma['nivel'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    required
                    min="1"
                    value="<?= htmlspecialchars($turma['capacidade'], ENT_QUOTES, 'UTF-8') ?>"
                >
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="local" 
                    class="form-control"
                    value="<?= htmlspecialchars($turma['local'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
            ...
            <div class="form-group">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1rem; margin-top: 0.5rem;">
                    ...
                    $diasSelecionados = !empty($turma['dias_array']) && is_array($turma['dias_array']) ? $turma['dias_array'] : [];
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control" 
                        required
                        value="<?= htmlspecialchars($turma['hora_inicio'], ENT_QUOTES, 'UTF-8') ?>"
                    >
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        class="form-control" 
                        required
                        value="<?= htmlspecialchars($turma['hora_fim'], ENT_QUOTES, 'UTF-8') ?>"
                    >
            ...
            <div class="form-group">
                ...
                <select id="ativo" name="ativo" class="form-control">
                    <option value="1" <?= $turma['ativo'] ? 'selected' : '' ?>>Ativa</option>
                    <option value="0" <?= !$turma['ativo'] ? 'selected' : '' ?>>Inativa</option>
                </select>
            ...
            <div class="form-actions">
                ...
                <a href="<?= BASE_URL ?>/turmas/<?= $turma['id'] ?>" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</div>
