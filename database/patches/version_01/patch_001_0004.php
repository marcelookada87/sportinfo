 ...
 * 
 * Data: 2025-12-06
 * Descrição: Adiciona campos para telefone, email e telegram do pai e da mãe
 */

return [
    'version' => '001_0004',
    'description' => 'Adiciona campos de contato dos pais (telefone, email, telegram)',
    'date' => '2025-12-06',
    'sql_file' => __DIR__ . '/patch_001_0004.sql',
    'execute' => function(PDO $pdo): bool {
        // Lê e executa o arquivo SQL
        $sqlFile = __DIR__ . '/patch_001_0004.sql';
